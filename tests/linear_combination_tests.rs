...
mod linear_combination_tests {
    use linear_algebra_42::{linear_combination, LinearCombinationError, Vector};
    ...
    fn test_linear_combination_i8() {
        let v1 = Vector::from([1i8, 2i8, 3i8]);
    ...
    fn test_linear_combination_i64() {
        let v1 = Vector::from([1000000i64, 2000000i64, 3000000i64]);
    ...
    fn test_linear_combination_f32() {
        let v1 = Vector::from([1.5f32, 2.5f32, 3.5f32]);
    ...
    fn test_linear_combination_with_fractional_coefficients() {
        let v1 = Vector::from([2.0, 4.0, 6.0]);
    ...
    fn test_linear_combination_very_small_coefficients() {
        let v1 = Vector::from([1000000.0, 2000000.0]);
